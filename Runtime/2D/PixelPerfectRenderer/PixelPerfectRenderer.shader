Shader "NooTools/2D/PixelPerfectRenderer"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t v)
            {
                ...
                OUT.textureCoords = v.texcoord.xy * _MainTex_TexelSize.zw;
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float2 finalTextureCoords = (floor(IN.textureCoords) + interpolationAmount) / _MainTex_TexelSize.zw;
                return tex2D(_MainTex, finalTextureCoords) * IN.color;
                ...
                half4 color = IN.color * half4(1.0,1.0,1.0,texColor.a);
