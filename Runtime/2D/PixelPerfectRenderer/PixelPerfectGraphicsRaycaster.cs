...
{
    [AddComponentMenu("Event/Pixel Perfect Graphic Raycaster")]
    [RequireComponent(typeof(Canvas))]
    /// <summary>
    /// A derived BaseRaycaster to raycast against Graphic elements.
    /// </summary>
    public class PixelPerfectGraphicRaycaster : BaseRaycaster
    {
        ...
        protected PixelPerfectGraphicRaycaster()
        { }
        ...
        [NonSerialized] private List<Graphic> m_RaycastResults = new();
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
        {
            ...
            Vector3 eventPosition = eventData.position / screenScale;
