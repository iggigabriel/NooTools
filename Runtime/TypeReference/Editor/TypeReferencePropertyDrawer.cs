...
namespace Noo.Tools
{
    ...
    public sealed class TypeReferencePropertyDrawer : PropertyDrawer
    {
        ...
        private static List<Type> GetFilteredTypes(TypeConstraintAttribute filter)
        {
        ...
        private static string DrawTypeSelectionControl(Rect position, GUIContent label, string classRef, TypeConstraintAttribute filter)
        {
            ...
            if (triggerDropDown)
            {
                if (filter == null)
                {
                    throw new Exception("Missing TypeReference constraint attribute.");
                }
        ...
        private static void DrawTypeSelectionControl(Rect position, SerializedProperty property, GUIContent label, TypeConstraintAttribute filter)
        {
            try
            {
        ...
        {
            DrawTypeSelectionControl(position, property.FindPropertyRelative("_classRef"), label, attribute as TypeConstraintAttribute);
        }
